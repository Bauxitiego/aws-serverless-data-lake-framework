...
devops_account () { 
    ...
    declare -a REPOSITORIES=("sdlf-cicd" "sdlf-catalog" "sdlf-foundations" "sdlf-team" "sdlf-pipeline" "sdlf-dataset" "sdlf-datalakeLibrary" "sdlf-stageA" "sdlf-stageB" "sdlf-main")
